            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="max-w-3xl mx-auto py-12 px-6 bg-white shadow-md rounded-lg grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <form method="POST" action="{{ route('mcreate') }}" class="space-y-6">
                            @csrf

                            <div class="mb-4">
                                <label for="company_name" class="block text-gray-700 font-semibold mb-2">Name</label>
                                <input type="text" id="name" name="name" placeholder="Member Name..."value="{{ old('name') }}"class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                @error('name')
                            ...
                            <div class="mb-4">
                                ...
                                <select name="role" id="role"  class="min-w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
