                        ...
                        <div class="table-container max-w-5xl mx-auto overflow-x-auto">
                            ...
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <p class="text-3xl font-bold text-gray-800 text-gray-700 mb-4">
                                    ...
                                    0
                                    @endif
                                    of {{ $users->total() }} records
                                </p>

                                <!-- Button / Link -->
                                <a href="{{ route('members') }}" class="px-4 py-2 bg-blue-600 font-semibold rounded-lg shadow hover:bg-blue-700 transition-colors duration-200 bg-blue-600">
                                    View All
                                </a>
                                {{-- Pagination links hidden or removed --}}
                                {{-- <div class="hidden">{{ $users->links() }}</div> --}}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 text-gray-900">
                <div class="p-6 text-gray-900 max-w-5xl mx-auto bg-white p-6 rounded shadow overflow-x-auto">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('genurls') }}" class="px-4 py-2 bg-blue-600 font-semibold rounded-lg shadow hover:bg-blue-700 transition-colors duration-200 bg-blue-600" style="float: right;">
                            View All
                        </a>
                        <a href="{{ route('genrateurl') }}" class="px-4 py-2 bg-blue-600 font-semibold rounded-lg shadow hover:bg-blue-700 transition-colors duration-200 bg-blue-600">
                            Generate
                        </a>
                    </div>
                    <div class="table-container max-w-5xl mx-auto overflow-x-auto">
